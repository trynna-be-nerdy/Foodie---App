...
import {clearCurrentScan} from '../store/slices/receiptSlice';
...
export function ReceiptConfirmationScreen({
  route,
  navigation,
}: ReceiptConfirmationScreenProps): React.JSX.Element {
          ...
          <View style={styles.pointsContainer}>
            ...
            <Animated.Text style={styles.pointsValue}>
              {pointsAnim.interpolate({
                inputRange: [0, pointsEarned],
                outputRange: ['0', pointsEarned.toString()],
              })}
            </Animated.Text>
            <Text style={styles.pointsSuffix}>points</Text>
          </View>

          <Text style={styles.subtitle}>Your points have been added to your wallet</Text>
        </Animated.View>
