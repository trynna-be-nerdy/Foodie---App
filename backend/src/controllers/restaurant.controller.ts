...
const searchSchema = z.object({
  ...
  priceRange: z.string().optional(), // 1-4
  city: z.string().optional(),
  limit: z.string().optional().default('20'),
  offset: z.string().optional().default('0'),
});

const locationCountSchema = z.object({
 ...
 */
export async function getRestaurantById(req: AuthenticatedRequest, res: Response): Promise<void> {
  try {
    const { id } = req.params;
 ...
 */
export async function getLoyaltyRestaurants(req: Request, res: Response): Promise<void> {
  try {
 ...
 */
export async function updateRestaurantLocationCount(
